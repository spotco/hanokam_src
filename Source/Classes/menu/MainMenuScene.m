...
-(id)init {
	...
	_entry_field = (CCTextField*)[[CCTextField textFieldWithSpriteFrame:
		[CCSpriteFrame frameWithTexture:[Resource get_tex:TEX_BLANK] rectInPixels:entry_field_rect rotated:NO offset:CGPointZero originalSize:entry_field_rect.size]]
